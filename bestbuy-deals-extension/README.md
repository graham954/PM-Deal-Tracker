# Best Buy Member Deals Scraper (Chrome extension)

Scrapes **every page** of the My Best Buy+ member deals list by reading the page's
...
3. Click **Load unpacked** and select this `bestbuy-deals-extension` folder.
4. Pin the extension (puzzle-piece icon → pin) so you can click it easily.

## Use (each refresh)
1. Log in to Best Buy and set your store to **Lexington** (so pickup/availability text
   reflects your store).
...
## If it collects 0 deals (Best Buy changed their markup)
